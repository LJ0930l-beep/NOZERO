...
export default function AssessmentPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await apiFetch("/api/v1/assessments", { method: "POST", body: JSON.stringify({ user_id: userId, ...values }) });
