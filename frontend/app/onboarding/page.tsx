      ...
      <div className="flow-page">
        ...
        <form className="flow-card" onSubmit={submit}>
          <div className="form-grid">
            ...
            <div className="field"><label htmlFor="goal">Primary goal</label><select id="goal" value={form.primary_goal} onChange={(e) => update("primary_goal", e.target.value)}><option value="fat_loss">Fat loss</option><option value="abs">Abs</option><option value="muscle_gain">Muscle gain</option><option value="body_shaping">Body shaping</option><option value="strength">Strength</option><option value="cardio_fitness">Cardio fitness</option><option value="core_strength">Core strength</option><option value="mobility">Mobility</option><option value="build_exercise_habit">Build exercise habit</option></select></div>
            <div className="field"><label htmlFor="focus">Secondary focus</label><select id="focus" value={form.secondary_focus} onChange={(e) => update("secondary_focus", e.target.value)}><option value="full_body">Full body</option><option value="abs">Abs</option><option value="chest">Chest</option><option value="back">Back</option><option value="shoulders">Shoulders</option><option value="arms">Arms</option><option value="glutes">Glutes</option><option value="legs">Legs</option><option value="mobility">Mobility</option></select></div>
