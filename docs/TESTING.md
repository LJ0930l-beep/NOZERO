...
- `python -m pytest -q` covers safety override, goal differentiation, equipment/noise behavior, assessment dimensions, progression, recovery, discipline, API core flow, reassessment-driven plan refresh, data controls, AI guardrails, and pose uncertainty (34 tests in the current release candidate).
